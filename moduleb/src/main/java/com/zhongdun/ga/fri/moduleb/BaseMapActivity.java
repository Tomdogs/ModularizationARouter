...
import com.zhongdun.ga.fri.moduleb.overlayUtil.PoiOverlay;

import java.util.ArrayList;
import java.util.List;
@Route(path = "/moduleB/1")
public class BaseMapActivity extends Activity implements SensorEventListener,
    ...
    private BDLocation currentLocation ;//定位后记录下来，有bug，要是又移动了，这个会不会改变，待测
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lineLoc = (LinearLayout) findViewById(R.id.lineLoc);
        textRes = (TextView) findViewById(R.id.textRes);
        back = (ImageView) findViewById(R.id.back);
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                lineLoc.setVisibility(View.GONE);
                textRes.setVisibility(View.VISIBLE);
            }
        });
        textRes.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                lineLoc.setVisibility(View.VISIBLE);
       ...
       /* AlertDialog.Builder builder = new AlertDialog.Builder(getApplication());
        ...
        /*//mMapView.setZoomControlsPosition(new Point());
        LogoPosition lp = mMapView.getLogoPosition();
        int scalaHeight = mMapView.getScaleControlViewHeight();//比例尺的高度
        Log.i("8888888:",""+scalaHeight+";"+ mMapView.getScaleX());*/

        mBaiduMap = mMapView.getMap();

        initMapView();
        initPio();
        ILog.i("8888888:","放大放大放大放大放大");

        //mBaiduMap.setCompassEnable();
        //mBaiduMap.setMyLocationEnabled(true);
        // 隐藏缩放控件
        //mMapView.showZoomControls(true);

        //获取mapview中的缩放控件
        //ZoomControls zoomControls = (ZoomControls) mMapView.getChildAt(1);
    ...
    public void currentLoc(View view){
        ...
        Toast.makeText(BaseMapActivity.this,"当前activity："+ BaseApplication.getTopActivity(),Toast.LENGTH_SHORT).show();
    }
    ...
    public void onGetPoiResult(PoiResult result) {
        if (result == null || result.error == SearchResult.ERRORNO.RESULT_NOT_FOUND) {
            Toast.makeText(BaseMapActivity.this, "未找到结果", Toast.LENGTH_LONG)
                    .show();
            return;
        }
        ...
        if (result.error == SearchResult.ERRORNO.AMBIGUOUS_KEYWORD) {
            ...
            strInfo += "找到结果";
            Toast.makeText(BaseMapActivity.this, strInfo, Toast.LENGTH_LONG)
                    .show();
        }
    }
    ...
    public void onGetPoiDetailResult(PoiDetailResult result) {
        if (result.error != SearchResult.ERRORNO.NO_ERROR) {
            Toast.makeText(BaseMapActivity.this, "抱歉，未找到结果", Toast.LENGTH_SHORT)
                    .show();
        } else {
            Toast.makeText(BaseMapActivity.this, result.getName() + ": " + result.getAddress(), Toast.LENGTH_SHORT)
                    .show();
        }
    }
    ...
    public void onGetSuggestionResult(SuggestionResult res) {
        ...
        sugAdapter = new ArrayAdapter<String>(BaseMapActivity.this, android.R.layout.simple_dropdown_item_1line, suggest);
        keyWorldsView.setAdapter(sugAdapter);
